...
class ClientsController extends abstractController
{
  use InputFilter;
  use Helper;
  public $current_model = "project\models\ClientsModel";
  public function defaultAction(){
      $this->data['clients'] = $this->current_model::select_items("","fetchAll");
      $this->view();
  }
  public function addAction(){
    if (isset($_POST['submit'])){
     ...
     if ($current_data->insert("")){
        ...
        $this->redirect('/project/admin/clients');
     }
    }
    $this->view();
}
public function editAction(){
  ...
  $this->data['clients'] = $this->current_model::select_items($id,"fetch");
  if ($this->data ===false){
      $this->redirect('/project/admin/clients');
  }
  if (isset($_POST['submit'])){
